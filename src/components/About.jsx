...
const About = () => {
  return (
    ...
    // <div
    //   name="about"
    //   className="w-full bg-[#0a192f] text-gray-300 flex flex-col items-center justify-center p-4 pb-16 sm:pb-12"
    //   //className="w-full min-h-screen bg-[#0a192f] text-gray-300 flex flex-col items-center justify-center p-4 pb-16 sm:pb-12"
    // >
    //   <div className="max-w-[1000px] w-full">
    //     {/* Header */}
    //     <div className="mb-8">

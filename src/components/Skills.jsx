...
//     <div
//       name="skills"
//       className="w-full h-[100vh] bg-[#0a192f] text-gray-300 pt-40 sm:pt-0"
//     >
//       <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
//         {/* Section Header */}
//         <div>
...
//           <div className="shadow-md shadow-[#474c52] hover:scale-110 duration-500 h-[8rem]">
//             <img className="w-20 mx-auto" src={ReactNode} alt="React icon" />
//             <p className="my-4">REACTJS + Node</p>
//             <p className="my-4">REACT NATIVE</p>
//           </div>
...
//               className="w-24 mx-auto"
//               src={Mobile}
//               alt="Flutter/Kotlin icon"
//             />
//             <p className="my-4">Flutter/Kotlin</p>
//           </div>

//           <div className="shadow-md shadow-[#474c52] hover:scale-110 duration-500 h-[8rem]">
//             <img className="w-24 mx-auto" src={PythonImg} alt="Python icon" />
//             <p className="my-4">PYTHON</p>
//           </div>

//           <div className="shadow-md shadow-[#474c52] hover:scale-110 duration-500 h-[8rem]">
//             <img className="w-20 h-20 mx-auto" src={JavaImg} alt="Java icon" />
//             <p className="my-4">JAVA</p>
//           </div>
...
//           <div className="shadow-md shadow-[#474c52] hover:scale-110 duration-500 h-[8rem]">
//             <img className="w-24 mx-auto" src={PHP} alt="PHP icon" />
//             <p className="my-4">PHP & MYSQL</p>
//           </div>

//           <div className="shadow-md shadow-[#474c52] hover:scale-110 duration-500 h-[8rem]">
//             <img className="w-20 h-20 mx-auto" src={Mongo} alt="MongoDB icon" />
//             <p className="my-4">MONGO DB</p>
//           </div>
...
const Skills = () => {
  return (
    ...
    <div
      name="skills"
      className="w-full min-h-screen bg-[#0a192f] text-gray-300 pt-40 sm:pt-0"
    >
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        {/* Section Header */}
        <div>
